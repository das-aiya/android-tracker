...
public class MainActivity extends ActionBarActivity {
    ...
    static MyDataLogger dataLogger;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainTextView = (TextView)findViewById(R.id.test);

        myContext = this.getApplicationContext();
        dataLogger = new MyDataLogger(myContext);
        locationManager = (LocationManager) myContext.getSystemService(LOCATION_SERVICE);
        locationListener = new MyLocationListener(dataLogger, locationManager);
